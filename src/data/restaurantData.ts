...
export const galleryImages: GalleryImage[] = [
  // GREAT HALL
  { id: "gh1", category: "great-hall", src: "/placeholder.svg", alt: "Great Hall overview", caption: "The magnificent Great Hall" },
  { id: "gh2", category: "great-hall", src: "/placeholder.svg", alt: "Great Hall tables", caption: "Elegant table settings" },
  { id: "gh3", category: "great-hall", src: "/placeholder.svg", alt: "Great Hall chandelier", caption: "Historic chandelier" },
  { id: "gh4", category: "great-hall", src: "/placeholder.svg", alt: "Great Hall entrance", caption: "Grand entrance" },
  { id: "gh5", category: "great-hall", src: "/placeholder.svg", alt: "Great Hall detail", caption: "Architectural details" },
  ...
  // PAINTED HALL
  { id: "ph1", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall murals", caption: "Historic murals" },
  { id: "ph2", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall ceiling", caption: "Painted ceiling" },
  { id: "ph3", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall tables", caption: "Intimate dining" },
  { id: "ph4", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall art", caption: "Georgian artistry" },
  { id: "ph5", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall corner", caption: "Cozy corner" },
  { id: "ph6", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall window", caption: "Natural light" },
  { id: "ph7", category: "painted-hall", src: "/placeholder.svg", alt: "Painted Hall detail", caption: "Artistic details" },
...
export const highlights = [
  { icon: "ChefHat", title: "Chef's Specials", titleGe: "შეფ-მზარეულის სპეციალი", description: "Daily creations from our kitchen" },
  { icon: "Home", title: "Private Cabins", titleGe: "კერძო კაბინები", description: "Intimate dining experiences" },
  { icon: "Building", title: "Great Hall Celebrations", titleGe: "დიდი დარბაზის ზეიმი", description: "Events up to 200 guests" },
  { icon: "Leaf", title: "Seasonal Ingredients", titleGe: "სეზონური ინგრედიენტები", description: "Farm-fresh produce daily" },
...
export const faqItems = [
  {
    ...
    answer: "Yes, we highly recommend making a reservation, especially for weekends and holidays. You can call us directly or use our online reservation form.",
  ...
  },
  {
    ...
    answer: "Yes, we offer several private cabins that can accommodate 4-12 guests. Perfect for family gatherings or intimate celebrations.",
    answerGe: "დიახ, გვაქვს რამდენიმე კერძო კაბინა 4-12 სტუმრისთვის.",
  },
  {
    question: "Do you have vegetarian options?",
    questionGe: "გაქვთ ვეგეტარიანული კერძები?",
    answer: "Absolutely! Georgian cuisine has many delicious vegetarian dishes. Try our pkhali, lobio, or various cheese dishes.",
  ...
  },
  {
    ...
    answer: "Yes, we love hosting birthday celebrations! We have spaces for intimate gatherings up to grand celebrations for 200+ guests.",
  ...
  },
  {
    ...
    answer: "Absolutely! Our Great Hall can accommodate up to 200 guests, and we have various spaces for groups of all sizes.",
...
export const reviews = [
  { id: 1, name: "Giorgi M.", rating: 5, text: "The best khinkali in Tbilisi! Authentic atmosphere and wonderful service.", date: "2 weeks ago" },
  { id: 2, name: "Anna K.", rating: 5, text: "We celebrated our anniversary here. The private cabin was perfect and the food was exceptional.", date: "1 month ago" },
  { id: 3, name: "David L.", rating: 5, text: "Traditional Georgian hospitality at its finest. The wine selection is impressive.", date: "3 weeks ago" },
  { id: 4, name: "Nino T.", rating: 4, text: "Great food and atmosphere. The khachapuri was delicious. Slightly slow service during busy hours.", date: "1 week ago" },
  { id: 5, name: "Michael R.", rating: 5, text: "A must-visit for anyone wanting authentic Georgian cuisine. The Great Hall is stunning.", date: "2 months ago" },
