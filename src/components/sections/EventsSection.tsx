        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            <span className="text-sm tracking-[0.2em] uppercase text-primary font-medium">
              {t("Live Entertainment", "ცოცხალი გასართობი")}
            </span>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mt-3 mb-4">
              {t("Dancing & Singing", "ცეკვა და სიმღერა")}
            </h2>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden group">
                <img
                  src={entertainment1}
                  alt={t("Georgian dancing at restaurant", "ქართული ცეკვა რესტორანში")}
                ...
                <div className="absolute bottom-3 left-3 flex items-center gap-2 text-primary-foreground">
                  ...
                  <span className="text-sm font-medium">{t("Live Music", "ცოცხალი მუსიკა")}</span>
                </div>
              </div>
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden group">
                <img
                  src={entertainment2}
                  alt={t("Georgian singing at restaurant", "ქართული სიმღერა რესტორანში")}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-charcoal/60 to-transparent" />
                <div className="absolute bottom-3 left-3 flex items-center gap-2 text-primary-foreground">
                  <Users className="h-4 w-4" />
                  <span className="text-sm font-medium">{t("Folk Songs", "ხალხური სიმღერები")}</span>
                </div>
              </div>
            </div>
